 ...
 */
public class StopBulkTimerAction extends AbstractCallableTimerAction<Map<TimerDescriptor, Boolean>> {
    ...
    public Map<TimerDescriptor, Boolean> call(IClusterTimerManager timerManager) throws DefaultTimerException {
        return timerManager.unwrap(ClusterTimerDestroyer.class).stopLocalTimersInternallyLock(timers);
    }
